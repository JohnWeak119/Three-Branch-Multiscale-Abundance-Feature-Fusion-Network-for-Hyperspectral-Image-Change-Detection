...
class HSICD_data(data.Dataset):
    def __init__(self, data_sample, cfg):
        ...
        if self.phase == 'train':
            ...
            self.data_indices = data_sample['val_sample_center']
    ...
    def __getitem__(self, idx):
        ...
        abu = self.abu[:, img_index[0]:img_index[1], img_index[2]:img_index[3]]
        label = self.gt[index[1], index[2]]

        return img1, img2, abu, label, index
